...
class _PlayerScreenState extends State<PlayerScreen> {
  ...
  bool _playerReady = false; // true só quando chewieController está pronto para renderizar
  ...
  Future<void> _abrirServidores(String idVideo, String nomeVideo, bool isParaDownload) async {
    ...
    if (!isParaDownload) {
      ...
      setState(() { 
        ...
        _playerReady = false; // garante que Chewie não tenta renderizar controller disposed
  ...
  void _iniciarExoPlayer(String url, String tituloEpisodio, {VideoPlayerController? controllerPreinit}) async {
    ...
    if (mounted) setState(() { isServerLoading = false; _playerReady = true; });
    ...
    _adTimer = Timer(const Duration(minutes: 3), () async {
      ...
      if (mounted) {
        setState(() { isServerLoading = false; isPlaying = false; _playerReady = false; });
    ...
    return Focus(
      ...
      child: Stack(
        ...
        children: [
          ...
          if (isPlaying && !isServerLoading && _playerReady && _chewieController != null)
